...
const Landing = () => {
  ...
  return (
    ...
    <div onClick={handleClick} className={`${click ? 'animate-fadeout':'fixed bg-black w-full left-0 h-full z-[1001] top-0 cursor-pointer'}`}>
      ...
      <Image unoptimized src='/ElevatedEventsMobile.gif' width={1080} height={1350} alt='Elevated Events Logo mobile' className='flex items-center justify-center z-[1001] object-contain w-full h-[100vh] mx-auto lg:hidden' />
